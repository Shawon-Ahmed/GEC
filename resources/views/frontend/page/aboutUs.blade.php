...
@section('header-title')
    <title>About Us | Greenhouse Engineering and Construction Engineering Consultency</title>
@endsection
        ...
        <div class="row pt-1 pb-4 mb-3">
            <div class="col">
                    ...
                    <div class="content-grid-item col-lg-3">
                        <div class="counters mb-4">
                            <div class="counter custom-sm-counter-style">
                                ...
                                <strong class="text-color-primary custom-primary-font pt-3 pb-0" data-to="15" data-append="+">15+</strong>
                    ...
                    <div class="content-grid-item col-lg-3">
                        <div class="counters mb-4">
                            <div class="counter custom-sm-counter-style">
                                ...
                                <strong class="text-color-primary custom-primary-font pt-3 pb-0" data-to="2000" data-append="+">2000+</strong>
                    ...
                    <div class="content-grid-item col-lg-3">
                        <div class="counters mb-4">
                            <div class="counter">
                                ...
                                <strong class="text-color-primary custom-primary-font pt-3 pb-0" data-to="240" data-append="+">240+</strong>
                    ...
                    <div class="content-grid-item col-lg-3 bg-color-light">
                        <div class="counters mb-4">
                            <div class="counter">
                                ...
                                <strong class="text-color-primary custom-primary-font pt-3 pb-0" data-to="130" data-append="+">130+</strong>
                ...
                <div class="row pb-4 pt-4 mt-4">
                    <div class="col-lg-4">
                        <img src="img/demos/business-consulting/cases/case-3.jpg" class="img-fluid mb-4" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="img/demos/business-consulting/cases/case-4.jpg" class="img-fluid mb-4" alt="">
                    </div>
                    <div class="col-lg-4">
                        <img src="img/demos/business-consulting/cases/case-1.jpg" class="img-fluid mb-4" alt="">
                    </div>
                </div>
